...
export type SSEEvent = TokenEvent | PhaseEvent | PermissionRequestEvent | ToolExecutedEvent | AssistantTextEvent | ResultEvent | ErrorEvent | PlanModeEvent | PromptSuggestionEvent | ToolActivityEvent | TaskEvent | ToolProgressEvent;
